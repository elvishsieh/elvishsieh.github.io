!(function (e, t) {
            ...
            function x(e, t) {
                var i = m({}, A, t),
                    a = e.map(function (e) {
                        ...
                        return (
                            (function (e) {
                                (e.originalStyle = { whiteSpace: e.element.style.whiteSpace, display: e.element.style.display, fontSize: e.element.style.fontSize }), S(e), (e.newbie = !0), (e.dirty = !0), r.push(e);
                            })(t),
                            { element: e, fit: y(t, s), unfreeze: E(t), freeze: R(t), unsubscribe: w(t) }
                        );
                    });
                return l(), a;
            }
    ...
    class b {
        ...
        load(e, i = {}) {
            ...
            if (a) {
                ...
                s && this.shouldPreload(a) && !/autoplay=(1|true|yes)/gi.test(n) && s.getAttribute("src") !== n && s.setAttribute("src", n);
            }
            this.layout(e);
        }
        layout(e) {
            Array.from(e.querySelectorAll(".r-fit-text")).forEach((e) => {
                f(e, { minSize: 24, maxSize: 0.8 * this.Reveal.getConfig().height, observeMutations: !1, observeWindow: !1 });
            });
        }
        unload(e) {
                ...
                t(e, "iframe[data-src]").forEach((e) => {
                    (r(e, ".fragment") && !r(e, ".fragment.visible")) ||
                        (e.getAttribute("src") !== e.getAttribute("data-src") &&
                            (e.removeEventListener("load", this.startEmbeddedIframe), e.addEventListener("load", this.startEmbeddedIframe), e.setAttribute("src", e.getAttribute("data-src"))));
                }));
        }
    ...
    const w = (e) => {
        ...
        if (i && i[1]) return (i = i[1]), { r: parseInt(i.slice(0, 2), 16), g: parseInt(i.slice(2, 4), 16), b: parseInt(i.slice(4, 6), 16) };
    ...
    class E {
        ...
        sync(e) {
            ...
            e.classList.remove("has-dark-background"),
                ...
                (i.style.opacity = ""),
                (i.innerHTML = ""),
                a.background && (/^(http|file|\/\/)/gi.test(a.background) || /\.(svg|png|jpg|jpeg|gif|bmp|webp)([?#\s]|$)/gi.test(a.background) ? e.setAttribute("data-background-image", a.background) : (t.style.background = a.background)),
                (a.background || a.backgroundColor || a.backgroundGradient || a.backgroundImage || a.backgroundVideo || a.backgroundIframe) &&
                    t.setAttribute(
            ...
            if (s) {
                const t = w(s);
                t && 0 !== t.a && ("string" == typeof (r = s) && (r = w(r)), (r ? (299 * r.r + 587 * r.g + 114 * r.b) / 1e3 : null) < 128 ? e.classList.add("has-dark-background") : e.classList.add("has-light-background"));
            }
            var r;
        }
        update(e = !1) {
                    ...
                    i.classList.remove("past", "present", "future"),
                        ...
                        (e || o === a.h) &&
                            t(i, ".slide-background").forEach((e, t) => {
                                e.classList.remove("past", "present", "future"), t < a.v ? e.classList.add("past") : t > a.v ? e.classList.add("future") : (e.classList.add("present"), o === a.h && (n = e));
                            });
                }),
        ...
        updateParallax() {
            ...
            if (this.Reveal.getConfig().parallaxBackgroundImage) {
                ...
                let c,
                    ...
                    g = n.length;
                (c = "number" == typeof this.Reveal.getConfig().parallaxBackgroundVertical ? this.Reveal.getConfig().parallaxBackgroundVertical : (i - u) / (g - 1)),
                    (h = g > 0 ? c * e.v : 0),
    ...
    const R = ".slides section",
        ...
        k = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener|showPreview/,
    ...
    class x {
        ...
        run(e, t) {
            ...
            if (e.hasAttribute("data-auto-animate") && t.hasAttribute("data-auto-animate") && e.getAttribute("data-auto-animate-id") === t.getAttribute("data-auto-animate-id") && !(a > n ? t : e).hasAttribute("data-auto-animate-restart")) {
                ...
                let r = this.getAutoAnimatableElements(e, t).map((e) => this.autoAnimateElements(e.from, e.to, e.options || {}, i, C++));
                if ((s && (e.style.display = "none"), "false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched)) {
                    let e = 0.8 * i.duration,
                        a = 0.2 * i.duration;
                    this.getUnmatchedAutoAnimateElements(t).forEach((e) => {
                        let t = this.getAutoAnimateOptions(e, i),
                            a = "unmatched";
                        (t.duration === i.duration && t.delay === i.delay) || ((a = "unmatched-" + C++), r.push(`[data-auto-animate="running"] [data-auto-animate-target="${a}"] { transition: opacity ${t.duration}s ease ${t.delay}s; }`)),
                            (e.dataset.autoAnimateTarget = a);
                    }, this),
                        r.push(`[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${e}s ease ${a}s; }`);
                }
        ...
        autoAnimateElements(e, t, i, a, n) {
            ...
            if (t.classList.contains("fragment") && (delete o.styles.opacity, e.classList.contains("fragment"))) {
                (e.className.match(L) || [""])[0] === (t.className.match(L) || [""])[0] && "forward" === a.slideDirection && t.classList.add("visible", "disabled");
            }
            if (!1 !== i.translate || !1 !== i.scale) {
                ...
                if (a || n) {
                    let e = [];
                    a && e.push(`translate(${t.x}px, ${t.y}px)`), n && e.push(`scale(${t.scaleX}, ${t.scaleY})`), (r.styles.transform = e.join(" ")), (r.styles["transform-origin"] = "top left"), (o.styles.transform = "none");
                }
            }
        ...
        getAutoAnimateOptions(t, i) {
            let a = { easing: this.Reveal.getConfig().autoAnimateEasing, duration: this.Reveal.getConfig().autoAnimateDuration, delay: 0 };
                ...
                (i.styles || a.autoAnimateStyles).forEach((t) => {
                    ...
                    "string" == typeof t && (t = { property: t }),
                        void 0 !== t.from && "from" === e
                            ...
                            : ("line-height" === t.property && (i = parseFloat(s["line-height"]) / parseFloat(s["font-size"])), isNaN(i) && (i = s[t.property])),
        ...
        getAutoAnimatePairs(e, t) {
            ...
            return (
                ...
                this.findAutoAnimateMatches(i, e, t, "img, video, iframe", (e) => e.nodeName + ":::" + (e.getAttribute("src") || e.getAttribute("data-src"))),
                ...
                i.forEach((e) => {
                    s(e.from, a)
                        ...
                        : s(e.from, "pre") &&
                          ...
                          this.findAutoAnimateMatches(i, e.from, e.to, ".hljs .hljs-ln-code", (e) => e.textContent, { scale: !1, styles: [], measure: this.getLocalBoundingBox.bind(this) }),
                          this.findAutoAnimateMatches(i, e.from, e.to, ".hljs .hljs-ln-line[data-line-number]", (e) => e.getAttribute("data-line-number"), { scale: !1, styles: ["width"], measure: this.getLocalBoundingBox.bind(this) }));
                }, this),
                i
            );
        }
                ...
                Array.from(t).forEach((t, a) => {
                    if ((t.hasAttribute("data-fragment-index") && (a = parseInt(t.getAttribute("data-fragment-index"), 10)), (n = Math.max(n, a)), a <= e)) {
                        ...
                        t.classList.add("visible"),
                            ...
                            a === e && (this.Reveal.announceStatus(this.Reveal.getStatusText(t)), t.classList.add("current-fragment"), this.Reveal.slideContent.startEmbeddedContent(t)),
                            n || (i.shown.push(t), this.Reveal.dispatchEvent({ target: t, type: "visible", bubbles: !1 }));
                    } else {
                        let e = t.classList.contains("visible");
                        t.classList.remove("visible"), t.classList.remove("current-fragment"), e && (this.Reveal.slideContent.stopEmbeddedContent(t), i.hidden.push(t), this.Reveal.dispatchEvent({ target: t, type: "hidden", bubbles: !1 }));
                    }
                }),
        ...
        goto(e, t = 0) {
            ...
            if (i && this.Reveal.getConfig().fragments) {
                ...
                if (a.length) {
                    ...
                    return (
                        n.hidden.length && this.Reveal.dispatchEvent({ type: "fragmenthidden", data: { fragment: n.hidden[0], fragments: n.hidden } }),
                        n.shown.length && this.Reveal.dispatchEvent({ type: "fragmentshown", data: { fragment: n.shown[0], fragments: n.shown } }),
    ...
    class N {
        ...
        activate() {
            if (this.Reveal.getConfig().overview && !this.isActive()) {
                ...
                this.Reveal.dispatchEvent({ type: "overviewshown", data: { indexh: a.h, indexv: a.v, currentSlide: this.Reveal.getCurrentSlide() } });
            }
        }
        layout() {
        ...
        update() {
            ...
            this.Reveal.transformSlides({ overview: ["scale(" + t + ")", "translateX(" + -i.h * this.overviewSlideWidth + "px)", "translateY(" + -i.v * this.overviewSlideHeight + "px)"].join(" ") });
        }
        deactivate() {
            if (this.Reveal.getConfig().overview) {
                ...
                this.Reveal.slide(e.h, e.v), this.Reveal.layout(), this.Reveal.cueAutoSlide(), this.Reveal.dispatchEvent({ type: "overviewhidden", data: { indexh: e.h, indexv: e.v, currentSlide: this.Reveal.getCurrentSlide() } });
            }
        }
        toggle(e) {
    ...
    class M {
        ...
        addKeyBinding(e, t) {
            "object" == typeof e && e.keyCode ? (this.bindings[e.keyCode] = { callback: t, key: e.key, description: e.description }) : (this.bindings[e] = { callback: t, key: null, description: null });
        }
        removeKeyBinding(e) {
        ...
        onDocumentKeyDown(e) {
            ...
            !1 === h &&
                ...
                80 === i || 33 === i
                    ...
                    : (h = !1)),
                h ? e.preventDefault && e.preventDefault() : (27 !== i && 79 !== i) || (!1 === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e.preventDefault && e.preventDefault()),
    ...
    class D {
        constructor(e) {
            var t, i, a;
            (a = 1e3),
                (i = "MAX_REPLACE_STATE_FREQUENCY") in (t = this) ? Object.defineProperty(t, i, { value: a, enumerable: !0, configurable: !0, writable: !0 }) : (t[i] = a),
                (this.Reveal = e),
        ...
        debouncedReplaceState(e) {
            clearTimeout(this.replaceStateTimeout),
                Date.now() - this.replaceStateTimestamp > this.MAX_REPLACE_STATE_FREQUENCY ? this.replaceState(e) : (this.replaceStateTimeout = setTimeout(() => this.replaceState(e), this.MAX_REPLACE_STATE_FREQUENCY));
        }
        getHash(e) {
            let t = "/",
                    ...
                    if (
                        ...
                        if (t) {
                            ...
                            n.classList.add("speaker-notes"),
                                ...
                                (n.innerHTML = t),
                                "separate-page" === a ? g.push(n) : ((n.style.left = i + "px"), (n.style.bottom = i + "px"), (n.style.width = s - 2 * i + "px"), f.appendChild(n));
                        }
                    }
                    if (a) {
            ...
            if (this.touchCaptured) v && e.preventDefault();
                ...
                if (1 === e.touches.length && 2 !== this.touchStartCount) {
                    ...
                    s > 40 && Math.abs(s) > Math.abs(r)
                        ...
                        : r < -40 && n.down && ((this.touchCaptured = !0), "linear" === t.navigationMode ? this.Reveal.next() : this.Reveal.down()),
    ...
    class W {
        ...
        focus() {
            this.state !== O && (this.Reveal.getRevealElement().classList.add("focused"), document.addEventListener("pointerdown", this.onDocumentPointerDown, !1)), (this.state = O);
        }
        blur() {
            this.state !== U && (this.Reveal.getRevealElement().classList.remove("focused"), document.removeEventListener("pointerdown", this.onDocumentPointerDown, !1)), (this.state = U);
        }
        isFocused() {
            return this.state === O;
        }
    ...
    class V {
        ...
        render() {
            ...
            this.context.save(),
                ...
                this.context.stroke(),
                this.playing && (this.context.beginPath(), this.context.arc(i, a, t, r, s, !1), (this.context.lineWidth = this.thickness), (this.context.strokeStyle = "#fff"), this.context.stroke()),
                ...
                this.playing
                    ...
                    : (this.context.beginPath(), this.context.translate(4, 0), this.context.moveTo(0, 0), this.context.lineTo(24, 14), this.context.lineTo(0, n), (this.context.fillStyle = "#fff"), this.context.fill()),
    ...
    function X(s, l) {
        ...
        function pe(e) {
            ...
            if (((X.wrapper = s), (X.slides = s.querySelector(".slides")), !X.slides)) throw 'Unable to find slides container (<div class="slides">).';
            return (w = { ...$, ...w, ...l, ...e, ...d() }), me(), window.addEventListener("load", Ue, !1), ce.load(w.plugins, w.dependencies).then(fe), new Promise((e) => h.on("ready", e));
        }
        function me() {
            !0 === w.embedded ? (X.viewport = r(s, ".reveal-viewport") || s) : ((X.viewport = document.body), document.documentElement.classList.add("reveal-full-page")), X.viewport.classList.add("reveal-viewport");
        }
        function fe() {
            (L = !0),
                be(),
                ...
                ie.update(!0),
                setTimeout(() => {
                    X.slides.classList.remove("no-transition"), X.wrapper.classList.add("ready"), Ie({ type: "ready", data: { indexh: u, indexv: v, currentSlide: m } });
                }, 1),
                he.isPrintingPDF() &&
                    (xe(),
        ...
        function ye() {
            X.slides.classList.add("no-transition"),
                g ? X.wrapper.classList.add("no-hover") : X.wrapper.classList.remove("no-hover"),
                ie.render(),
                ee.render(),
                oe.render(),
                le.render(),
                ve.render(),
                (X.pauseOverlay = o(X.wrapper, "div", "pause-overlay", w.controls ? '<button class="resume-button">Resume presentation</button>' : null)),
                (X.statusElement = we()),
        ...
        function Se() {
            setInterval(() => {
                (0 === X.wrapper.scrollTop && 0 === X.wrapper.scrollLeft) || ((X.wrapper.scrollTop = 0), (X.wrapper.scrollLeft = 0));
            }, 1e3);
        }
        function Ae() {
            document.addEventListener("fullscreenchange", Kt), document.addEventListener("webkitfullscreenchange", Kt);
        }
        function ke() {
        ...
        function Le(t) {
            ...
            X.wrapper.classList.remove(a.transition),
                ...
                X.wrapper.setAttribute("data-background-transition", w.backgroundTransition),
                ...
                !1 === w.pause && Je(),
                w.previewLinks ? (Fe(), ze("[data-preview-link=false]")) : (ze(), Fe("[data-preview-link]:not([data-preview-link=false])")),
                te.reset(),
                f && (f.destroy(), (f = null)),
                n > 1 && w.autoSlide && w.autoSlideStoppable && ((f = new V(X.wrapper, () => Math.min(Math.max((Date.now() - J) / _, 0), 1))), f.on("click", $t), (Q = !1)),
                "default" !== w.navigationMode ? X.wrapper.setAttribute("data-navigation-mode", w.navigationMode) : X.wrapper.removeAttribute("data-navigation-mode"),
                ve.configure(w, a),
                ue.configure(w, a),
                de.configure(w, a),
                oe.configure(w, a),
        ...
        function Ce() {
            window.addEventListener("resize", Ut, !1),
                ...
                w.focusBodyOnPageVisibilityChange && document.addEventListener("visibilitychange", Wt, !1);
        }
        function xe() {
            ge.unbind(),
                ue.unbind(),
        ...
        function Pe() {
            xe(),
                ...
                X.wrapper.classList.remove("ready", "center", "has-horizontal-slides", "has-vertical-slides"),
        ...
        function De(e) {
            "string" == typeof e.layout && (U.layout = e.layout), "string" == typeof e.overview && (U.overview = e.overview), U.layout ? n(X.slides, U.layout + " " + U.overview) : n(X.slides, U.overview);
        }
        function Ie({ target: t = X.wrapper, type: i, data: a, bubbles: n = !0 }) {
            let s = document.createEvent("HTMLEvents", 1, 2);
            return s.initEvent(i, n, !0), e(s, a), t.dispatchEvent(s), t === X.wrapper && Te(i), s;
        }
        function Te(t, i) {
        ...
        function Be() {
            if (w.help) {
                Oe(), (X.overlay = document.createElement("div")), X.overlay.classList.add("overlay"), X.overlay.classList.add("overlay-help"), X.wrapper.appendChild(X.overlay);
        ...
        function Ue() {
            if (X.wrapper && !he.isPrintingPDF()) {
                if (!w.disableLayout) {
                    g && !w.embedded && document.documentElement.style.setProperty("--vh", 0.01 * window.innerHeight + "px");
                    const e = Ke(),
                        t = O;
                    We(w.width, w.height),
                        (X.slides.style.width = e.width + "px"),
                        (X.slides.style.height = e.height + "px"),
                        (O = Math.min(e.presentationWidth / e.width, e.presentationHeight / e.height)),
                        (O = Math.max(O, w.minScale)),
                        (O = Math.min(O, w.maxScale)),
                        1 === O
                            ? ((X.slides.style.zoom = ""), (X.slides.style.left = ""), (X.slides.style.top = ""), (X.slides.style.bottom = ""), (X.slides.style.right = ""), De({ layout: "" }))
                            : ((X.slides.style.zoom = ""),
                    ...
                    for (let t = 0, a = i.length; t < a; t++) {
                        ...
                        "none" !== a.style.display &&
                            (w.center || a.classList.contains("center") ? (a.classList.contains("stack") ? (a.style.top = 0) : (a.style.top = Math.max((e.height - a.scrollHeight) / 2, 0) + "px")) : (a.style.top = ""));
                    }
                    t !== O && Ie({ type: "resize", data: { oldScale: t, scale: O, size: e } });
                }
                X.viewport.style.setProperty("--slide-scale", O), le.update(), ie.updateParallax(), ne.isActive() && ne.update();
            }
        }
        function We(e, i) {
        ...
        function Ke(e, t) {
            const i = { width: w.width, height: w.height, presentationWidth: e || X.wrapper.offsetWidth, presentationHeight: t || X.wrapper.offsetHeight };
            return (
                ...
                "string" == typeof i.height && /%$/.test(i.height) && (i.height = (parseInt(i.height, 10) / 100) * i.presentationHeight),
                i
            );
        }
        function Ve(e, t) {
        ...
        function _e() {
            return !!m && !m.nextElementSibling && (!je(m) || !m.parentNode.nextElementSibling);
        }
        function Ge() {
            if (w.pause) {
                const e = X.wrapper.classList.contains("paused");
                xt(), X.wrapper.classList.add("paused"), !1 === e && Ie({ type: "paused" });
            }
        }
        function Je() {
            const e = X.wrapper.classList.contains("paused");
        ...
        function it(e, t, i, a) {
            if (Ie({ type: "beforeslidechange", data: { indexh: void 0 === e ? u : e, indexv: void 0 === t ? v : t, origin: a } }).defaultPrevented) return;
            p = m;
            const n = X.wrapper.querySelectorAll(S);
            if (0 === n.length) return;
            void 0 !== t || ne.isActive() || (t = $e(n[e])), p && p.parentNode && p.parentNode.classList.contains("stack") && Ve(p.parentNode, v);
            const s = z.concat();
            z.length = 0;
            let r = u || 0,
                o = v || 0;
            ...
            l && Ie({ type: "slidechanged", data: { indexh: u, indexv: v, previousSlide: p, currentSlide: m, origin: a } }),
        ...
        function at() {
            xe(),
                ...
                !1 === w.autoPlayMedia ? Z.stopEmbeddedContent(m, { unloadIframes: !1 }) : Z.startEmbeddedContent(m),
        ...
        function ot(e, i) {
            let a = t(X.wrapper, e),
                ...
                o = !1;
            if (n) {
                w.loop && (i >= n && (r = !0), (i %= n) < 0 && ((i = n + i), (o = !0))), (i = Math.max(Math.min(i, n - 1), 0));
                for (let e = 0; e < n; e++) {
                    let t = a[e],
                        n = w.rtl && !je(t);
                ...
                e.classList.add("present"), e.removeAttribute("hidden"), e.removeAttribute("aria-hidden"), t || Ie({ target: e, type: "visible", bubbles: !1 });
        ...
        function ct() {
            ...
            if (n && void 0 !== u) {
                ...
                g && (s = ne.isActive() ? 6 : w.mobileViewDistance), he.isPrintingPDF() && (s = Number.MAX_VALUE);
                for (let r = 0; r < n; r++) {
                    let o = a[r],
                        l = t(o, "section"),
                        d = l.length;
                    if (((e = Math.abs((u || 0) - r) || 0), w.loop && (e = Math.abs(((u || 0) - r) % (n - s)) || 0), e < s ? Z.load(o) : Z.unload(o), d)) {
                        let t = $e(o);
                        for (let a = 0; a < d; a++) {
                            let n = l[a];
                            (i = r === (u || 0) ? Math.abs((v || 0) - a) : Math.abs(a - t)), e + i < s ? Z.load(n) : Z.unload(n);
                        }
                    }
                }
                wt() ? X.wrapper.classList.add("has-vertical-slides") : X.wrapper.classList.remove("has-vertical-slides"), yt() ? X.wrapper.classList.add("has-horizontal-slides") : X.wrapper.classList.remove("has-horizontal-slides");
            }
        }
        function ht({ includeFragments: e = !1 } = {}) {
            let t = X.wrapper.querySelectorAll(S),
                i = X.wrapper.querySelectorAll(A),
                a = { left: u > 0, right: u < t.length - 1, up: v > 0, down: v < i.length - 1 };
            if (
                (w.loop && (t.length > 1 && ((a.left = !0), (a.right = !0)), i.length > 1 && ((a.up = !0), (a.down = !0))),
                t.length > 1 && "linear" === w.navigationMode && ((a.right = a.right || a.down), (a.left = a.left || a.up)),
                !0 === e)
            ) {
        ...
        function pt() {
            return t(X.wrapper, '.slides section:not(.stack):not([data-visibility="uncounted"])');
        }
        function mt() {
        ...
        function kt() {
            let e = vt();
            return { indexh: e.h, indexv: e.v, indexf: e.f, paused: Ze(), overview: ne.isActive() };
        }
        function Lt(e) {
            if ("object" == typeof e) {
                ...
                let t = a(e.paused),
                    i = a(e.overview);
                "boolean" == typeof t && t !== Ze() && Qe(t), "boolean" == typeof i && i !== ne.isActive() && ne.toggle(i);
            }
        }
        function Ct() {
            if ((xt(), m && !1 !== w.autoSlide)) {
                ...
                i
                    ...
                    !_ ||
                        ...
                        ((G = setTimeout(() => {
                            "function" == typeof w.autoSlideMethod ? w.autoSlideMethod() : zt(), Ct();
                        }, _)),
                        (J = Date.now())),
                    f && f.setPlaying(-1 !== G);
            }
        ...
        function Pt() {
            _ && !Q && ((Q = !0), Ie({ type: "autoslidepaused" }), clearTimeout(G), f && f.setPlaying(!1));
        }
        function Nt() {
        ...
        function Mt({ skipFragments: e = !1 } = {}) {
            (C.hasNavigatedHorizontally = !0),
                w.rtl
                    ? (ne.isActive() || e || !1 === ae.next()) && ht().left && it(u + 1, "grid" === w.navigationMode ? v : void 0)
                    : (ne.isActive() || e || !1 === ae.prev()) && ht().left && it(u - 1, "grid" === w.navigationMode ? v : void 0);
        }
        function Dt({ skipFragments: e = !1 } = {}) {
            (C.hasNavigatedHorizontally = !0),
                w.rtl
                    ? (ne.isActive() || e || !1 === ae.prev()) && ht().right && it(u - 1, "grid" === w.navigationMode ? v : void 0)
                    : (ne.isActive() || e || !1 === ae.next()) && ht().right && it(u + 1, "grid" === w.navigationMode ? v : void 0);
        }
        function It({ skipFragments: e = !1 } = {}) {
            (ne.isActive() || e || !1 === ae.prev()) && ht().up && it(u, v - 1);
        }
        function Tt({ skipFragments: e = !1 } = {}) {
            (C.hasNavigatedVertically = !0), (ne.isActive() || e || !1 === ae.next()) && ht().down && it(u, v + 1);
        }
        function Ft({ skipFragments: e = !1 } = {}) {
            if (e || !1 === ae.prev())
                if (ht().up) It({ skipFragments: e });
                    ...
                    let i;
                    if (((i = w.rtl ? t(X.wrapper, ".slides>section.future").pop() : t(X.wrapper, ".slides>section.past").pop()), i && i.classList.contains("stack"))) {
        ...
        function zt({ skipFragments: e = !1 } = {}) {
            if (((C.hasNavigatedHorizontally = !0), (C.hasNavigatedVertically = !0), e || !1 === ae.next())) {
                let t = ht();
                t.down && t.right && w.loop && Xe() && (t.down = !1), t.down ? Tt({ skipFragments: e }) : w.rtl ? Mt({ skipFragments: e }) : Dt({ skipFragments: e });
            }
        }
        function Ht(e) {
        ...
        function Bt(e) {
            "running" === Y && /section/gi.test(e.target.nodeName) && ((Y = "idle"), Ie({ type: "slidetransitionend", data: { indexh: u, indexv: v, previousSlide: p, currentSlide: m } }));
        }
        function Ot(e) {
        ...
        function Kt(e) {
            (document.fullscreenElement || document.webkitFullscreenElement) === X.wrapper &&
    ...
    let Y = X,
        _ = [];
    return (
        (Y.initialize = (e) => (Object.assign(Y, new X(document.querySelector(".reveal"), e)), _.map((e) => e(Y)), Y.initialize())),
