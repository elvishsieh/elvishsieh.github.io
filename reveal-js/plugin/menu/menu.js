...
var RevealMenu = window.RevealMenu || (function(){
	...
	options.path = options.path || scriptPath() || '/reveal-js/plugin/menu/';
	...
	loadResource(options.path + 'menu.css', 'stylesheet', function() {
		if (loadIcons) {
			loadResource('/font-awesome/css/all.css', 'stylesheet', loadPlugin)
		} else {
			loadPlugin();
		}
	})
	...
	function loadPlugin() {
		...
		if (initialise) {
			...
			var themesPath = typeof options.themesPath === 'string' ? options.themesPath : '/reveal-js/css/theme/';
