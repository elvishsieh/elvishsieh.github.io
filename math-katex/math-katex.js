...
window.RevealMath = window.RevealMath || (function() {
	...
	options.katexScript     = options.katexScript     || '/math-katex/lib/katex-0.10.0/katex.min.js';
	options.katexStylesheet = options.katexStylesheet || '/math-katex/lib/katex-0.10.0/katex.min.css';
	...
	var defaults = {
		...
		// found
		cdn: {
			script:     'https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.10.0-beta/katex.min.js',
			stylesheet: 'https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.10.0-beta/katex.min.css'
		},
